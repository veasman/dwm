...
static const char *fonts[]          = { "Fira Code NF:size=10" };
static const char dmenufont[]       = "Fira Code NF:size=10";
static const char col_gray1[]       = "#1e2127";
static const char col_gray2[]       = "#5c6370";
static const char col_gray3[]       = "#e6efff";
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_gray1, "-nf", col_gray3, "-sb", col_cyan, "-sf", col_gray4, "-x", "710", "-y", "350", "-z", "500", "-l", "20", "-p", "Run:", NULL };
